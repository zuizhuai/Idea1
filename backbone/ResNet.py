...
if __name__ == '__main__':
    path = 'C:\\Users\\DELL\\.cache\\torch\hub\checkpoints\\resnet50-19c8e357.pth'
    img_path = 'D:\Github\Data\COD10K-v3\Train\Image\COD10K-CAM-1-Aquatic-1-BatFish-1.jpg'
    img = cv2.imread(img_path)
    img = cv2.resize(img, dsize=(224, 224))
    cv2.imshow('resize_img', img)
    model = ResNet_2Branch()
